def zadanie1():
    ...
    ice_cream_stand = IceCreamStand("Мороженое-Мир", "Мороженое", ["Ваниль", "Шоколад", "Манго", "Клубника"])
...
def zadanie2():
    ...
    # Создание экземпляра IceCreamStand
    ice_cream_stand = IceCreamStand("Мороженое-Мир", "Мороженое", ["Ваниль", "Шоколад", "Манго", "Клубника"],"ул. Ленина, 10", "9:00 - 21:00")
